interface IObserver<T>{  // generic <T> el tipo se lo damos en el momento de la creacion del objeto.
...
const subject = new Subject<number>(); // generic <T> el tipo se lo damos en el momento de la creacion del objeto.
